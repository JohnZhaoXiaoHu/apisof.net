...
public sealed partial class ApiCatalogModel
{
    internal sealed class Converter
    {
        ...
        private readonly Dictionary<int, int> _frameworkOffsetById = new();
        private readonly Dictionary<int, int> _packageOffsetById = new();
        private readonly Dictionary<int, int> _assemblyOffsetById = new();
        private readonly Dictionary<int, int> _usageSourceOffsetById = new();
        private readonly Dictionary<int, int> _apiOffsetById = new();
